        ...
        <main className="flex flex-row px-8 pt-10 pb-2 justify-between gap-8">
          ...
          <div className="w-full">
            <div className="relative w-80 h-80 overflow-hidden rounded-lg">
              {/* ✅ Use a plain <img> with the base64 src — always captured */}
              <img
                src={imageSrc}
                alt="Profile"
          ...
          <div className="w-full">
            ...
            {/*
              ✅ KEY FIX: All data fields are plain <div>/<h2> elements,
              NOT form inputs. html-to-image / modern-screenshot can
              capture these perfectly on iOS Safari.
            */}
